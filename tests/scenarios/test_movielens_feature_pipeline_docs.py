...
def test_public_indexes_and_projection_count_the_current_production_apps_and_dags():
    assert "Six CI-built Maven applications" in _read(ROOT / "README.md")
    assert "Six CI-built Maven applications" in _read(ROOT / "docs/index.md")
    ...
    assert "eight production DAGs" in catalog
