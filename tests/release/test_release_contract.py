...
@pytest.mark.parametrize(
    ...
    [
        ...
        "<audio><h3>Added</h3><ul><li>hidden only</li></ul></audio>",
        "<canvas><h3>Added</h3><ul><li>hidden only</li></ul></canvas>",
        "<iframe><h3>Added</h3><ul><li>hidden only</li></ul></iframe>",
        "<meter><h3>Added</h3><ul><li>hidden only</li></ul></meter>",
        '<object data="about:blank"><h3>Added</h3><ul><li>hidden only</li></ul></object>',
        "<picture><h3>Added</h3><ul><li>hidden only</li></ul></picture>",
        "<progress><h3>Added</h3><ul><li>hidden only</li></ul></progress>",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "<iframe>{evidence}</iframe>",
        "<meter>{evidence}</meter>",
        '<object data="about:blank">{evidence}</object>',
