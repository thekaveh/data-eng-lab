...
![Architecture](../../docs/diagrams/img/time_travel-nyc_taxi-spark-iceberg.png)
...
- [Related: table_maintenance-nyc_taxi-spark-iceberg](../table_maintenance-nyc_taxi-spark-iceberg/README.md) — Demonstrates compaction and snapshot cleanup on a separate scenario table
