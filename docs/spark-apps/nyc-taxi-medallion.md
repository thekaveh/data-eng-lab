...
![Architecture](../diagrams/img/nyc-taxi-medallion.png)
...
- [Medallion scenario](../scenarios/medallion-nyc_taxi-spark-iceberg.md)
- [Batch-ingest scenario](../scenarios/batch_ingest-nyc_taxi-spark-iceberg.md)
