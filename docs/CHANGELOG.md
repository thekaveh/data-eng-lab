...
### Changed
- Atlas consumer operations now pin `882877a4` (superseding the failed-gate
  ...
  claimed until its live retest. The separate #792 SparkSubmitHook status-poll
  caveat remains documented.
