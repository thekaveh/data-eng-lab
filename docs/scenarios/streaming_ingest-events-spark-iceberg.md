# 5.4. streaming_ingest-events-spark-iceberg
...
![Architecture](../diagrams/img/streaming_ingest-events-spark-iceberg.png)
...
- [Downstream: cdc_streaming-online_retail-spark-iceberg](./cdc_streaming-online_retail-spark-iceberg.md) — Related streaming scenario using CDC topic
