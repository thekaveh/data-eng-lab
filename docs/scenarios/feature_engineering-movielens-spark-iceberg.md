# 5.11. feature_engineering-movielens-spark-iceberg
...
![Architecture](../diagrams/img/feature_engineering-movielens-spark-iceberg.png)
...
- [Production application](../spark-apps/movielens-feature-pipeline.md)
