"""Airflow DAG for snapshot-bound NYC taxi Bronze quality controls."""
...
class AtlasSparkSubmitOperator(SparkSubmitOperator):
    """Keep Airflow's operator lifecycle while confirming the terminal REST driver."""
...
spark_conf = {
    ...
    "spark.app.name": "nyc-taxi-data-quality",
...
with DAG(
    ...
    description="Validate the matching NYC taxi Bronze snapshot and publish Silver quality partitions and Gold facts.",
    ...
    submit_quality = AtlasSparkSubmitOperator(
    ...
    wait_for_bronze >> submit_quality
